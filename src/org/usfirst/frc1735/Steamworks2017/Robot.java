...
public class Robot extends IterativeRobot {
    ...
    public static SendableChooser<String> allianceChooser; // Choose red or blue.  Affects crab direction in autonomous
    ...
    public static PopTart popTart;
    public static GearPresence gearPresence;
    ...
    // commenting out END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        autoChooser.addObject("Mobility",  new AutonomousMobility());
        autoChooser.addDefault("Center Peg", new AutonomousCenterPeg());
        autoChooser.addObject("Left Peg",  new AutonomousLeftPeg());
        autoChooser.addObject("Right Peg",  new AutonomousRightPeg());
        autoChooser.addObject("Hopper and Shoot", new AutonomousHopperAndShoot());
        autoChooser.addObject("Experimental",  new AutonomousExperiment());
        // Add the chooser widget to the dashboard
        SmartDashboard.putData("Autonomous Mode Chooser", autoChooser);
                
        // Radio buttons to choose alliance color (Because querying DriverStation was giving us odd/random results)
        allianceChooser = new SendableChooser();
        allianceChooser.addDefault("Red/Right", "Red");
        allianceChooser.addObject("Blue/Left", "Blue");
        // Add the chooser widget to the dashboard
    ...
    public void teleopInit() {
        ...
        // Ensure that the robot is always in traction mode at the start of Teleop:
  ...
  // Hard code alliance
    public static boolean m_isBlue = true;
