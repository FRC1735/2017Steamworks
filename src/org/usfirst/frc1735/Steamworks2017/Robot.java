...
public class Robot extends IterativeRobot {
    ...
    public void autonomousInit() {
    	...
    	ahrs.zeroYaw(); // Init the gyro to zero degrees at the start of the match to compensate for any drift that occurred while disabled and waiting for match to start
