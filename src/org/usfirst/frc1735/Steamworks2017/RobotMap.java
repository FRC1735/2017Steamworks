...
public class RobotMap {
    ...
    public static Solenoid turretCameraLightRelay;
    public static CANTalon shooterShootMaster;
    public static CANTalon shooterShootFollower;
    public static SpeedController gearVisionFakeMotor;
    public static AnalogGyro gearVisionFakeCameraGyro;
    public static Solenoid gearVisionCameraLightRelay;
    public static SpeedController feederFeederMotor;
    public static SpeedController climberMotor;
    public static Solenoid popTartSolenoid;
    public static DigitalInput gearPresenceBannerSensor;
    public static Solenoid gearPresenceGearPresenceRelay;
    ...
    public static void init() {
        ...
        turretCameraLightRelay = new Solenoid(0, 3);
        ...
        gearVisionFakeMotor = new Talon(19);
        LiveWindow.addActuator("GearVision", "FakeMotor", (Talon) gearVisionFakeMotor);
        
        gearVisionFakeCameraGyro = new AnalogGyro(1);
        LiveWindow.addSensor("GearVision", "FakeCameraGyro", gearVisionFakeCameraGyro);
        gearVisionFakeCameraGyro.setSensitivity(0.007);
        gearVisionCameraLightRelay = new Solenoid(0, 2);
        LiveWindow.addActuator("GearVision", "CameraLightRelay", gearVisionCameraLightRelay);
        
        feederFeederMotor = new VictorSP(0);
        LiveWindow.addActuator("Feeder", "FeederMotor", (VictorSP) feederFeederMotor);
        
        climberMotor = new Spark(1);
        LiveWindow.addActuator("Climber", "Motor", (Spark) climberMotor);
        
        popTartSolenoid = new Solenoid(0, 7);
        LiveWindow.addActuator("PopTart", "Solenoid", popTartSolenoid);
        
        gearPresenceBannerSensor = new DigitalInput(0);
        LiveWindow.addSensor("GearPresence", "BannerSensor", gearPresenceBannerSensor);
        
        gearPresenceGearPresenceRelay = new Solenoid(0, 1);
        LiveWindow.addActuator("GearPresence", "GearPresenceRelay", gearPresenceGearPresenceRelay);
