...
public class OI {
    ...
    public JoystickButton extendPopTartButton;
    public JoystickButton retractPopTartButton;
    ...
    public OI() {
        ...
        retractPopTartButton = new JoystickButton(operator, 7);
        retractPopTartButton.whenPressed(new RetractPopTart());
        extendPopTartButton = new JoystickButton(operator, 6);
        extendPopTartButton.whenPressed(new ExtendPopTart());
        climbDown = new JoystickButton(operator, 5);
        climbDown.whileHeld(new ClimbRope(-1));
        ...
        forceMecanumButton = new JoystickButton(joyRight, 2);
