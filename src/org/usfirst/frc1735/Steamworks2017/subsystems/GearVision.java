...
public class GearVision extends PIDSubsystem {
    ...
    // b) Use the encoders for continuous feedback because they run at a much faster rate
...
*/    	
    ...
    public double calculateDistanceFromCamera(double targetWidthPixels) {
    	...
    	if (targetWidthPixels > 0) {
    		...
    		// (10.2*320)/(2*Tpx*tan(30.521) = 
    		manualDistance = 2768.2656/targetWidthPixels;
    		...
    		distance = 10; //Arbitrary but hopefully reasonable value for "punting"...
