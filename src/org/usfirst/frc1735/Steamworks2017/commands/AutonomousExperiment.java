...
public class AutonomousExperiment extends CommandGroup {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	//System.out.println("Creating command AutonomousExperiment");
    	addSequential(new Delay(0.5)); // Let traction turn on before we try to move.  	
    	addSequential(new TurretWithLimits(-0.5)); // turn left until soft stop reached

    	addSequential(new Delay(0.5)); // Just wait.  Just because.
    	addSequential(new TurretWithLimits(0.5)); // turn right until soft stop reached
