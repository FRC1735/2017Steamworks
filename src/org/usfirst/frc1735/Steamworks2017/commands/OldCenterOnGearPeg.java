 ...
 *
 */
public class OldCenterOnGearPeg extends Command {
    ...
    protected void initialize() {
    	...
    	// Enable the vision subsystem (also turns on camera light)
       	...
       	m_wheelRotationSetpoint = errorDistance/Robot.driveTrain.m_inchesPerRevolution;
       	Robot.driveTrain.setGearMode(); // Enable the pid.  (@FIXME:  Bury this inside setVisionEnable?)
       	Robot.driveTrain.setGearSetpoint(m_wheelRotationSetpoint);
   }
    ...
    // Member Variables
    double m_wheelRotationSetpoint; // the rotational setpoint (with initial position being 0 rotations).  Positive is to the right.
}
